...
public class DoomChit extends JFrame {
	...
	public void paint(Graphics g) {
		...
		screenDraw((Graphics2D) screenGraphic);  // 글자 깨짐 완화
		g.drawImage(screenImage, 0, 0, null);
	}

	public void screenDraw(Graphics2D g) {  // 글자 깨짐 완화 "Graphics2D"
		...
		if(isGameScreen) {
			...
			g.drawString("ellis - clear my head", 20, 702);
